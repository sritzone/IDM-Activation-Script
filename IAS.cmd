...
::
::   Homepages: https://github.com/sritzone/IDM-Activation-Script
::
::============================================================================
...
echo:
echo:
call :_color2 %_White% "             " %_Green% "Powered By - SR IT ZONE
echo:            ___________________________________________________ 
echo:
echo:               Github: https://github.com/sritzone
echo:            ___________________________________________________ 
echo:                                                               
echo:               [1] Activate
echo:               [2] Freeze Trial
...
if %_erl%==6 exit /b
if %_erl%==5 start https://github.com/sritzone/IDM-Activation-Script & goto MainMenu
